            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-[#666] font-mono">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <span className="flex items-center gap-1">By <a href="https://github.com/codershubinc" target="_blank" className="hover:text-[#007acc] transition-colors">Swapnil Ingle</a></span>
                    </div>
                </div>
            </div>
        </footer>
